...
{
     public class SingleMenuViewComponent : ViewComponent
     {
        ...
        public SingleMenuViewComponent(IUnitOfWork unitOfWork, IHttpContextAccessor httpContextAccessor, ApplicationDbContext db, UserManager<ApplicationUser> userManager)
        {
